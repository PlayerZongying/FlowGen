...
Flow::FlowInitializeData Flow::Initialize(int aWidth, int aHeight)
{
    ...
    appleTexture = new Texture("Assets/Images/Apple_diffuse.jpg");
    ...
    // ResourceHandler::Instance().CreateMesh("Assets/Models/stbr.obj", "stbr");
    ...
    // StbrMesh = ResourceHandler::Instance().GetMesh("stbr");
    ...
    // {
    //     VirtualObject* flag = new VirtualObject(FlagMesh, myTexture, NormalView);
    ...
    //     sphere->Scale = glm::vec3(0.01f, 0.01f, 0.01f);
    // }
    ...
    for (size_t i = 0; i < 1; i++)
    {
        ...
        apple->Scale = glm::vec3(10.f, 10.f, 10.f);
    }
