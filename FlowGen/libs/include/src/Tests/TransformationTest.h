#ifndef _Transformation_Test_H_
#define _Transformation_Test_H_
...
inline int TransformationTest()
{
    ...
    // ------------------------------------
    Shader ourShader("Shader/TransformationTestVS.glsl", "Shader/TransformationTestFS.glsl");
