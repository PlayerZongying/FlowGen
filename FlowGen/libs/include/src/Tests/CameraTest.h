...
inline int CameraTest2()
{
    ...
    Texture* t1 = new Texture("Textures/Mona_Lisa.jpg");
    Texture* t2 = new Texture("Textures/Girl_with_a_Pearl_Earring.jpg");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(GL_TEXTURE_2D, t2->TextureObject);
        
        std::cout<<t1->TextureObject<<"\n"<<t2->TextureObject<<"\n";
